<?php foreach ($issues['issues'][$tabnextQuestionId]['answers'] as $section): ?>
	<div class="row">
		...
		<div class="col-md-6">
			<div class="btn-group">
			<?php if ($section['label'] == 'Other' && $section['nextQuestionId'] == $tabnextQuestionId && $answer['nextQuestionId'] != 179): ?>
				...
				<ul class="dropdown-menu dwopdown-menu noclose">
			    	<?php  foreach ($issues['issues'][$section['nextQuestionId']]['answers'] as $answer): ?>
			    		...
			    		<li<?php echo ($answer['nextQuestionId'] != $tabnextQuestionId && $answer['nextQuestionId'] != 179) ? ' class="dropdown-submenu dwopdown-submenu"' : ''; ?>>
			    			...
			    			<?php if ($answer['nextQuestionId'] != $tabnextQuestionId && $answer['nextQuestionId'] != 179)
			    				echo make_children_answers($root_question = $tabnextQuestionId, $question_id = $answer['nextQuestionId'], $issues, $inspection_id);
			    			 ?>
			    		</li>
			    	<?php endforeach; ?>

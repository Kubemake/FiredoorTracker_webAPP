...
class Tests extends CI_Controller {
	...
	function index()
	{
		...
		$this->_show('5. wrong password', 						array('type' => 'auth', 'login' => 'apitest@yahoo.com',	'password' => '1241'));
		$out = $this->_show('6. normal login', 					array('type' => 'auth', 'login' => 'apitest@yahoo.com',	'password' => '124'));

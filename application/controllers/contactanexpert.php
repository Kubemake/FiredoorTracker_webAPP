		...
		if ($postdata = $this->input->post())
		{
			...
			switch ($postdata['form_type'])
			{
				case 'add_expert':
					...
					$this->history_library->saveExperts(array('line_id' => $newins, 'new_val' => json_encode($insdata), 'type' => 'add'));
				...
				case 'edit_expert':
					$this->history_library->saveExperts(array('line_id' => $postdata['expert_id'], 'new_val' => json_encode($insdata), 'type' => 'edit'));
